...
<head>
  ...
  <style>
    ...
    body{
      ...
      background:
        radial-gradient(1100px 520px at 15% 10%, rgba(255,255,255,.08) 0%, rgba(255,255,255,0) 60%),
        radial-gradient(900px 520px at 95% 90%, rgba(255,255,255,.06) 0%, rgba(255,255,255,0) 60%),
        linear-gradient(135deg, var(--violeta-2) 0%, var(--violeta-1) 100%);
      min-height:100vh; overflow-x:hidden;
    }
    .scene{ min-height:100vh; display:flex; align-items:center; padding:48px 20px; }
    ...
    .top-brand img{ height:26px; filter:drop-shadow(0 2px 6px rgba(0,0,0,.35)); }
    .intro{ color:#efeaff; } .intro h1{ font-weight:800; margin-bottom:14px; font-size:48px; color:#f6f2ff; text-shadow:0 2px 12px rgba(0,0,0,.18); }
    .login-card{ max-width:460px; margin-left:auto; background:var(--card); backdrop-filter:blur(10px); -webkit-backdrop-filter:blur(10px); border:1px solid rgba(255,255,255,.28); border-radius:22px; padding:32px; box-shadow:0 18px 40px rgba(0,0,0,.26); }
    ...
    @media (max-width:991.98px){ .intro-col{ display:none; } .form-col{ padding-left:0; padding-right:0; } .login-card{ margin:0 auto; } .scene{ padding-top:96px; } }
  </style>
</head>
<body>

  <div class="top-brand">
    <img src="assets/img/itrade.png" alt="" onerror="this.style.display='none'">
    <span>iTrade 3.0</span>
  </div>

  <main class="scene">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-7 intro-col mb-5 mb-lg-0">
          <div class="intro">
            <h1>¡Bienvenid@ a iTrade 3.0!</h1>
        ...
        <div class="col-lg-5 form-col">
          <div class="login-card">
            ...
            <!-- IMPORTANTE: POST directo al PHP -->
            <form method="POST" action="pages/procesar_login.php" id="formLogin" autocomplete="off">
              ...
              <div class="text-center mt-3">
                <small class="muted">© <?php echo date('Y'); ?> iTrade 3.0</small>
              </div>
            </form>
          </div>
        </div>
  ...
  <script>
    ...
    // Loader visual (no bloquea el submit)
